...
namespace ASP_NetCore_Proyecto.Controllers
{
    public class EvaluacionController : Controller
    {
        ...
        {
            var escuelaContext = _context.Evaluaciónes.Include(e => e.Alumno).Include(e => e.Asignatura);
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var evaluacion = await _context.Evaluaciónes
                .Include(e => e.Alumno)
        ...
        public async Task<IActionResult> Edit(string id)
        {
            ...
            var evaluacion = await _context.Evaluaciónes.FindAsync(id);
            if (evaluacion == null)
            {
                return NotFound();
            }
        ...
        {
            var evaluacion = await _context.Evaluaciónes.FindAsync(id);
            _context.Evaluaciónes.Remove(evaluacion);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.Evaluaciónes.Any(e => e.Id == id);
        }
    }
}
